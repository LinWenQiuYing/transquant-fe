...
export default forwardRef(function SectorConf(props: CalculateConfProps, ref) {
  ...
  const defaultColumns: (ColumnTypes[number] & {
  ...
  })[] = [
    {
      title: (
        <div>
          <span className="mr-2 text-red-600">*</span>行业名称
        </div>
      ),
      dataIndex: "name",
      editable: true,
  ...
  return (
    <div className="factor-arg-config">
      <div className="font-bold">
        行业分类数据
        <Tooltip title="计算绩效分析和换手率指标时将会使用该数据">
