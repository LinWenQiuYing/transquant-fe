...
import { sync } from "../../factor-research/factor-lib/SearchHeader";

const { RangePicker } = DatePicker;

export type InputNumberType = number | undefined | null;
...
export default observer(function SearchHeader(props: {
  ...
  useMount(() => {
    getTagsByType(TagEnum.BACKTEST);
  });
  ...
  return (
    <div className="personal-strategy-lib">
              ...
              <Space.Compact>
                ...
                <InputNumber
                  ...
                  onChange={(value) =>
                    setConfig({
                      ...config,
                      maxDrawdownList: [config.maxDrawdownList?.[1], value],
                    })
                  }
                />
              </Space.Compact>
