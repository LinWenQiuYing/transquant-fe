...
export default observer(function PositionView() {
  const { positions, positionsLoading } = useStores().strategyResearchStore;

  const columns: ColumnsType<DataType<Position>> = [
    {
      title: "日期",
      dataIndex: "datetime",
      key: "datetime",
  ...
  return (
    <div>
      <Table
        columns={columns}
        dataSource={useDataSource<Position>(positions)}
        size="small"
