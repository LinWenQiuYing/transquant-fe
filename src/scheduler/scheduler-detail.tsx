...
import { queryProcessDefinitionByCode, updateProcessDefinition } from "./api";
...
export default function SchedulerDetail() {
  ...
  const getDefinition = () => {
    queryProcessDefinitionByCode(projectCode, code).then((res: any) => {
      setReadonly(res.processDefinition.releaseState === "ONLINE");
      setDefinition(res);
    });
  };
