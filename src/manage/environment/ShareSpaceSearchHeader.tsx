...
export default observer(function ShareSpaceSearchHeader() {
  const { getShareEnvList, onCacheEnvConfigChange, onPaginationChange } =
    useStores().environmentStore;
  const [config, setConfig] = useState<Partial<IShareSpaceSearch>>({});
      ...
      <Row justify="space-between" align="top">
        <Col span={24}>
          <Descriptions column={4} labelStyle={{ alignItems: "center" }}>
            <Descriptions.Item label="所属团队" className="w-96">
              <Input
                placeholder="请输入所属团队"
            ...
            <Col className="pl-4 text-right float-end">
              <Space>
                <Popover
