...
export default observer(function SearchHeader(props: {
  ...
  const { teams, publisherList, auditorList } =
    usePersonalStores().publishStore;
  const [config, setConfig] = useState<Partial<IApprovalSearch>>({});
  ...
  const collapseEl = (
    <Col span={8} style={{ textAlign: "right" }}>
      <Space>
        ...
        <Permission code="B160103" disabled>
